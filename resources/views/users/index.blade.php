...
<div class="container">
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2><i class="fas fa-users-cog me-2"></i>{{ __('messages.users') }}</h2>
            </div>
            <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a href="{{ route('admin.users.show', $user) }}" class="btn btn-info" title="{{ __('messages.view') }}">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.users.edit', $user) }}" class="btn btn-primary" title="{{ __('messages.edit') }}">
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="empty-state">
                                    ...
                                    <h5 class="text-muted mb-2">{{ __('messages.no_users_found') }}</h5>
                                    <a href="{{ route('admin.users.create') }}" class="btn btn-add mt-3">
                                        <i class="fas fa-plus me-2"></i>{{ __('messages.add_user') }}
                                    </a>
                                </td>
                            </tr>
