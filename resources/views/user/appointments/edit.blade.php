...
<div class="container">
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2><i class="fas fa-edit me-2"></i>{{ __('messages.edit_appointment') }}</h2>
            </div>
            <div>
    ...
    <div class="card form-card">
        <div class="card-body">
            <form action="{{ route('user.appointments.update', $appointment) }}" method="POST" class="needs-validation" novalidate>
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('appointment_date') is-invalid @enderror" id="appointment_date" name="appointment_date" value="{{ old('appointment_date', $appointmentDate ? $appointmentDate->format('Y-m-d') : '') }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="time" class="form-control @error('appointment_time') is-invalid @enderror" id="appointment_time" name="appointment_time" value="{{ old('appointment_time', $appointmentDate ? $appointmentDate->format('H:i') : '') }}" required>
