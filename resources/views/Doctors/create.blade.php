...
<div class="container">
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2><i class="fas fa-user-plus me-2"></i>{{ __('messages.add_doctor') }}</h2>
        </div>
            <div>
                ...
                <div class="mb-3">
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="create_user_account">
                            <i class="fas fa-user-plus me-1"></i>{{ __('messages.create_user_account_for_doctor') }}
                        </label>
                    </div>
                    <small class="text-muted">{{ __('messages.create_user_account_help') }}</small>
                </div>
